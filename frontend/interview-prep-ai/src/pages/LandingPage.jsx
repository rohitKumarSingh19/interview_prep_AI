          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
              ...
              <h1 className="text-5xl text-black font-medium mb-6 leading-tight">
                ...
                <span className="text-transparent bg-clip-text bg-[radial-gradient(circle,_#FF9324_0%,#FCD760_100%)] bg-[length:200%_200%] animate-text-shine font-semibold">AI-Powered</span> Learning
              </h1>
            </div>
              ...
              <div className="flex flex-col items-center gap-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
                  {APP_FEATURES.slice(0,3).map((feature)=>(
                    <div
                    key={feature.id}
                    className="bg-[#FFFEF8] p-6 rounded-xl shadows-xs hover:shadow-lg shadow-amber-100 transition border border-amber-100"
                    >
